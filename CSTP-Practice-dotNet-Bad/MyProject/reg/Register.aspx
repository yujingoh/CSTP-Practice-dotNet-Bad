<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"  CodeBehind="Register.aspx.cs" Inherits="ShoppingCart.Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr align="left">
        ...
        <td>
            <asp:TextBox ID="TextBox2" runat="server" Height="22px" Width="189px" Text="testuser1"></asp:TextBox>
    ...
    <tr>
        <td>
            ...
            <td><asp:TextBox ID="TextBox3" runat="server" Height="22px" Width="189px" Text="testuser1@nyp.edu.sg"
                         ></asp:TextBox> 
    ...
    <tr>
        ...
        <td>
            ...
            <asp:TextBox ID="TextBox7"   runat="server" EnableViewState="true" Height="22px" 
                Width="189px" Text="testuser1"   ></asp:TextBox>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="TextBox4" runat="server" EnableViewState="true" TextMode="Password" Height="22px" Width="189px" Text="password"></asp:TextBox>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="TextBox5" runat="server" Height="64px" TextMode="MultiLine" Width="189px" Text="NYP"></asp:TextBox>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="TextBox6" runat="server" Width="189px" Text="1234567890"></asp:TextBox>
