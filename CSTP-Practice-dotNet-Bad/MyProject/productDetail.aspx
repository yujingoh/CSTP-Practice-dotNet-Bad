<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="productDetail.aspx.cs" Inherits="ShoppingCart.productDetail"  %>
   ...
   <tr><td>
    <asp:DataList ID="DataList1" runat="server" DataKeyField="id" 
        ...
        <ItemTemplate>
            ...
            <br />
            <asp:ImageButton ID="ImageButton1" CausesValidation="false" runat="server" ImageUrl="~/img/buy_now.png" PostBackUrl='<%#"https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=cstp_biz@nyp.edu.com&item_name="+Eval("brand")+" "+Eval("productName")+"&item_number=132&amount="+Eval("price")%>' />
    ...
    <asp:ImageButton ID="ImageButton2" runat="server"   
        ImageUrl="~/img/str/buttons/addtocart1.png" onclick="ImageButton2_Click" />
    &nbsp;&nbsp;&nbsp;&nbsp;
